...
def premake_path() -> Path:
    ...
    match system:
        case "Windows": binary = "premake5-windows.exe"
        case "Linux": binary = "premake5-linux"
        case "Darwin": binary = "premake5-macosx-x64"
        case _: critical(f"Unsupported platform '{system}'!")
